...
\\ Purpose: It is use to retrieve and display posts from other users that the current user is following
\\ http://localhost:8081/
...
\\Purpose: Retrieve and display posts from the current user
...
\\ Purpose: Retrieve a specific post with its comments and details and diplay it
